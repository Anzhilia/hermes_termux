...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget build(BuildContext context) {
    // Error boundary: if the main build throws (e.g. PRoot not ready,
    // NativeBridge hang), show a retry screen instead of a black screen.
    try {
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            // Message platforms disabled — Hermes does not support CLI channel control
            // (OpenClaw uses npm plugins + `openclaw channel` which Hermes cannot do)
            // StatusCard(
            ...
            StatusCard(
              title: l10n.t('dashboardEditEnvTitle'),
              subtitle: l10n.t('dashboardEditEnvSubtitle'),
              icon: Icons.key_outlined,
              trailing: const Icon(Icons.chevron_right),
              onTap: () => _openScreen(const EnvEditorScreen()),
            ),
