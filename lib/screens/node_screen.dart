...
class _NodeScreenState extends State<NodeScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    final port = prefs.nodeGatewayPort ?? AppConstants.gatewayPort;
                            ...
                            if (!_isLocal) ...[
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: '${AppConstants.gatewayPort}',
                                ),
                              ...
                              FilledButton.icon(
                                onPressed: () async {
                                  ...
                                  final port = int.tryParse(
                                      ...
                                      AppConstants.gatewayPort;
                                  final token = _tokenController.text.trim();
                                  if (host.isNotEmpty) {
                                    await provider.connectRemote(host, port,
