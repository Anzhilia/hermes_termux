...
class LocalModelService {
  ...
  static const _moduleRootfsDir = 'root/.hermes/modules/llama.cpp';
  static const _modelsRootfsDir = 'root/.hermes/models';
  ...
  static const _runtimeGuestDir = '/root/.hermes/modules/llama.cpp/runtime';
  ...
  static const _modelsGuestDir = '/root/.hermes/models';
  static const _serverLogGuestPath =
      '/root/.hermes/modules/llama.cpp/logs/server.log';
  static const _installLogGuestPath =
      '/root/.hermes/modules/llama.cpp/logs/install.log';
...
rm -rf ${_shellQuote('/root/.hermes/modules/llama.cpp')}
''',
      timeout: 120,
    );
    ...
    try {
      final response = await http.get(
        ...
        headers: const {
          ...
          'User-Agent': 'hermes-agent-android',
        },
      );
...
''',
  ...
  static Map<String, String> _downloadHeadersForUri(Uri uri) {
    final headers = <String, String>{
      ...
      'User-Agent':
          'Mozilla/5.0 (Linux; Android 14) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0 Mobile Safari/537.36 HermesAgent',
    };
...
module_dir=${_shellQuote('/root/.hermes/modules/llama.cpp')}
...
mkdir -p "\$runtime_root" "\$module_dir/logs" ${_shellQuote('/root/.hermes/models')} ${_shellQuote('/usr/local/bin')}
: > "\$log_file"
