...
class PreferencesService {
  ...
  static const _keyNodeAutoConnect = 'node_auto_connect_with_gateway';
  ...
  Future<void> init() async {
    ...
    // Load saved GitHub proxy selection
    final savedProxyIndex = _prefs.getInt('github_proxy_index') ?? 0;
    AppConstants.selectedProxyIndex = savedProxyIndex;
  }

  // Generic helpers for settings that don't need dedicated getters
  ...
  /// 节点是否随网关自动连接/断开
  bool get nodeAutoConnectWithGateway => _prefs.getBool(_keyNodeAutoConnect) ?? true;
  set nodeAutoConnectWithGateway(bool value) => _prefs.setBool(_keyNodeAutoConnect, value);
