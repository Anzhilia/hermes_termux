...
class CpolarPackageService {
  ...
  static const _moduleRootfsDir = 'root/.hermes/modules/cpolar';
  ...
  static const _bashrcStartMarker = '# >>> hermes cpolar autostart >>>';
  static const _bashrcEndMarker = '# <<< hermes cpolar autostart <<<';
...
direct_install() {
  ...
  if [ ! -s "\$config_target" ] || grep -q 'Hermes Agent generated cpolar config\\.' "\$config_target" || grep -q 'All In Ubuntu generated cpolar config\\.' "\$config_target"; then
