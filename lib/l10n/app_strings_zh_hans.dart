const Map<String, String> appStringsZhHans = {
  ...
  'commonRetry': '重试',
  'commonSkip': '跳过',
  'setupWizardSkipToDashboard': '跳过 — 直接进入控制台',
  'setupWizardGatewayConfigMissingTitle': '配置不完整',
  'setupWizardGatewayConfigMissingBody': '未在 config.yaml 中检测到模型配置。你可以进入控制台稍后配置，或返回重试。',
  'setupWizardGoToDashboardAnyway': '进入控制台',
  'commonDone': '完成',
  'commonConfigure': '配置',
  'commonManage': '\u7ba1\u7406',
  'commonScreenshot': '截图',
  ...
  'dashboardTerminalSubtitle': '打开 Ubuntu Shell 并使用 Hermes Agent',
  'dashboardWebDashboardTitle': 'Web 控制台',
  'dashboardWebDashboardSubtitle': '在浏览器中打开 Hermes Agent 控制台',
  ...
  'dashboardEditConfigSubtitle': '直接编辑 config.yaml，保存前会自动校验',
  'dashboardEditEnvTitle': '修改环境变量',
  'dashboardEditEnvSubtitle': '编辑 .env 文件，配置 API Key 等环境变量',
  'dashboardProvidersTitle': 'AI 提供商',
  'dashboardProvidersSubtitle': '配置模型和 API Key',
  'dashboardCommandsTitle': '常用命令',
  'dashboardCommandsSubtitle': '查看并复制常用 Hermes Agent 命令',
  ...
  'dashboardHermesVersionLabel': '已安装版本',
  'dashboardHermesVersionUnknown': '未检测到',
  ...
  'gatewayUpdated': 'Hermes Agent 已更新到 {version}',
  'gatewayVersionListFailed': '加载可用版本失败：{error}',
  'gatewayAppliedVersion': 'Hermes Agent 已切换到 {version}',
  ...
  'gatewayNodeRequirementHint': '需要 Python {requirement}',
  ...
  'logsConversationEmpty': '在 /root/.hermes/sessions 中未找到对话日志。',
  ...
  'setupWizardTitle': '开始配置 Hermes Agent',
  'setupWizardIntroIdle': '这会将 Ubuntu、Python 和 Hermes Agent 下载到一个自包含环境中。',
  ...
  'setupWizardSelectVersion': 'Hermes Agent 版本',
  ...
  'setupWizardBootstrapNodeTitle': 'Python 运行时',
  'setupWizardBootstrapNodeSubtitle': '供安装流程解压 Python 运行时。',
  ...
  'setupWizardInstallMethodTitle': '安装方式',
  'setupWizardInstallMethodSh': '官方 install.sh（推荐）',
  'setupWizardInstallMethodShDesc': '使用 Hermes 官方安装脚本，自动处理依赖、Node.js 22、浏览器工具等。更完整，跟随上游更新。',
  'setupWizardInstallMethodPip': '快速 pip 安装',
  'setupWizardInstallMethodPipDesc': '直接下载源码 + pip install，更快但缺少浏览器工具等可选组件。',
  'setupWizardInstallMethodTerminal': '终端直装（curl | bash）',
  'setupWizardInstallMethodTerminalDesc': '在终端中直接运行官方安装脚本，实时查看输出，可交互。通过 gh-proxy.com 加速 GitHub 下载。',
  'terminalInstallTitle': '终端安装 Hermes Agent',
  'terminalInstallRunning': '正在安装，请保持应用前台运行…',
  'terminalInstallDone': '安装完成！',
  'terminalInstallFailed': '安装失败',
  'terminalInstallGoToDashboard': '进入控制台',
  'terminalInstallRetry': '重新安装',
  'setupWizardAdvancedLinksTitle': '安装链接配置',
  'setupWizardAdvancedLinksSubtitle': '如需自定义安装源，可在此修改链接',
  'setupWizardAdvancedLinksIntro': '以下链接用于安装过程中的资源下载。如无特殊需求，保持默认即可。',
  'setupWizardHermesInstallScriptUrl': 'install.sh 脚本地址',
  'setupWizardNodejsSetupUrl': 'Node.js 安装脚本地址',
  'setupWizardPipIndexUrl': 'pip 镜像源',
  'setupWizardPipIndexUrlHint': '留空使用默认源，或填写镜像地址',
  'setupWizardAdvancedLinksSave': '保存链接配置',
  'setupWizardAdvancedLinksReset': '恢复默认',
  'setupWizardSampleConfigDialogTitle': '发现内置示例配置',
  'setupWizardSampleConfigDialogBody':
      '检测到当前已安装的 Hermes Agent 版本为 {version}，并且应用内置了对应示例配置。\n\n使用示例配置后，可以跳过终端引导，直接进入首页；之后只需要去"AI 提供商"里把 Base URL、API Key 和模型改成你自己的即可。',
  'setupWizardSampleConfigTerminalOnboarding': '继续终端引导',
  'setupWizardSampleConfigUseSample': '使用示例配置',
  'setupWizardSampleConfigAppliedTitle': '示例配置已套用',
  'setupWizardSampleConfigAppliedBody':
      '已为 Hermes Agent {version} 套用内置示例配置。\n\n接下来会直接进入首页。进入后请打开"AI 提供商"，把 Base URL、API Key、模型改成你自己的，再启动 Gateway。',
  'setupWizardSampleConfigGoDashboard': '前往首页',
  'setupWizardSampleConfigApplyFailed': '套用内置示例配置失败，已回退到终端引导：{error}',
  'hermesInstallOptionsSummaryTitle': '推荐安装优化已启用',
  'hermesInstallOptionsAdvanced': '高级设置',
  'hermesInstallOptionsLiveLogs': '详细安装日志',
  'hermesInstallOptionsParallelSummary': '并行编译：{value}',
  'hermesInstallOptionsIgnoreScriptsChip': '跳过 pip scripts',
  'hermesInstallOptionsTitle': 'Hermes Agent 安装设置',
  'hermesInstallOptionsDescription':
      '这些推荐优化始终启用：关闭 pip install --no-cache-dir，显示详细安装日志，并开启并行编译。',
  'hermesInstallOptionsParallelLabel': '并行编译线程',
  'hermesInstallOptionsParallelAuto': '自动（推荐）',
  'hermesInstallOptionsParallelThreadCount': '{count} 线程',
  'hermesInstallOptionsParallelHint': '自动模式会根据 CPU 核心数，当前最多使用 {count} 个线程。',
  'hermesInstallOptionsIgnoreScriptsTitle':
      '跳过 pip scripts (--ignore-scripts)',
  'hermesInstallOptionsIgnoreScriptsSubtitle':
      '实验性选项。部分 Hermes Agent 版本安装后可能跳过插件或运行时依赖配置。',
  'setupWizardRequirements': '需要约 500MB 存储空间和网络连接',
  'setupWizardStorageDialogTitle': '安装前授予文件访问权限',
  'setupWizardStorageDialogBody':
      'Hermes Agent 在开始安装前需要文件管理权限，这样 Ubuntu 环境才能在 proot 中正确挂载共享存储。接下来会打开 Android 授权页面。',
  ...
  'setupWizardStepInstallPython': '安装 Python',
  'setupWizardStepInstallHermes': '安装 Hermes Agent',
  'setupWizardStepInstallHermesWithSize': '安装 Hermes Agent（{size}）',
  'setupWizardStepConfigureBypass': '配置环境变量',
  ...
  'setupWizardStatusDownloadingNode': '正在下载 Python {version}...',
  'setupWizardStatusDownloadingNodeProgress':
      '正在下载 Python：{current} MB / {total} MB',
  'setupWizardStatusExtractingNode': '正在解压 Python...',
  'setupWizardStatusVerifyingNode': '正在验证 Python...',
  'setupWizardStatusNodeInstalled': 'Python 已安装',
  'setupWizardStatusInstallingHermes': '正在安装 Hermes Agent...',
  'setupWizardStatusCreatingBinWrappers': '正在创建命令包装器...',
  'setupWizardStatusVerifyingHermes': '正在验证 Hermes Agent...',
  'setupWizardStatusHermesInstalled': 'Hermes Agent 已安装',
  'setupWizardStatusBypassConfigured': '环境变量已配置',
  'setupWizardStatusReady': '安装完成，可以开始启动网关了。',
  'onboardingTitle': 'Hermes Agent 引导配置',
  ...
  'onboardingOptionsBody':
      '这里会按真实的 `hermes setup` 流程展示全部步骤。必选步骤会锁定启用，未勾选的可选步骤会自动追加对应的 `--skip-*` 参数跳过。',
  ...
  'onboardingTerminalHeading': '=== Hermes Agent 引导配置 ===',
  ...
  'configureTerminalHeading': '=== Hermes Agent 配置 ===',
  'configureTerminalIntro': '这里只进入你刚才保留勾选的 Hermes Agent 配置分区。若全部勾选，则等同完整配置流程。',
  ...
  'configEditorSubtitle': '编辑 /root/.hermes/config.yaml，保存前会先进行 YAML 校验。',
  'configEditorRefresh': '重新加载',
  'configEditorFormat': '格式化 YAML',
  'configEditorSave': '保存',
  'configEditorSaving': '保存中...',
  'configEditorSaved': '配置已保存',
  'configEditorLoadFailed': '加载配置失败：{error}',
  'configEditorSaveFailed': '保存配置失败：{error}',
  'envEditorTitle': '修改环境变量',
  'envEditorSubtitle': '编辑 /root/.hermes/.env，配置 API Key 和环境变量。格式：KEY=value，每行一个。',
  'envEditorSaved': '.env 已保存',
  'envEditorSaveFailed': '保存 .env 失败：{error}',
  'configEditorValidationOk': 'YAML 校验通过',
  'configEditorValidationError': 'YAML 校验失败',
  'configEditorValidationFailed': '校验失败：{error}',
  'configEditorValidationObjectOnly': '根数据必须是一个 YAML 映射。',
  ...
  'commandShortcutsItemConfigureTitle': '打开 Hermes Agent 交互式配置',
  'nodeTitle': '节点',
  ...
  'settingsPersistentGatewayLogsSubtitle':
      '写入 /root/hermes.log，单文件超过 5MB 自动轮转，最多保留 3 份',
  ...
  'settingsStorageDialogBody':
      'Hermes Agent 需要文件管理权限，这样 Ubuntu 才能在 proot 中访问 /sdcard 等共享存储。接下来会跳转到 Android 授权页面。',
  'settingsStorageDialogAction': '继续',
  'onboardingStorageDialogTitle': '为引导配置授予文件访问权限',
  'onboardingStorageDialogBody':
      'Hermes Agent 引导配置需要文件管理权限，Ubuntu 才能在 proot 中挂载共享存储，并完成 API Key 与绑定配置。接下来会打开 Android 授权页面。',
  ...
  'configureStorageDialogBody':
      'Hermes Agent 配置页面需要文件管理权限，Ubuntu 才能在 proot 中挂载共享存储并管理网关设置。接下来会打开 Android 授权页面。',
  ...
  'settingsSnapshotVersionWarningHermesMismatch': '快照中的 Hermes Agent 版本与当前安装版本不一致。',
  ...
  'settingsBackupExportWorkspaceSubtitle': '打包 root/.hermes 中的配置、记忆与会话数据',
  'settingsBackupExportConfig': '配置文件',
  'settingsBackupExportConfigSubtitle': '仅导出 config.yaml',
  'settingsBackupImportConfigWarningTitle': '覆盖当前配置文件？',
  'settingsBackupImportConfigWarningBody':
      '这会直接覆盖当前的 config.yaml。应用语言、节点配对、自启动等应用偏好不会一起恢复，导入前会先停止网关。',
  'settingsBackupImportWorkspaceWarningTitle': '恢复工作目录备份？',
  'settingsBackupImportWorkspaceWarningBody':
      '这会覆盖 root/.hermes 下与配置、记忆、技能、扩展和会话相关的数据，并在导入前先停止网关。为了避免版本耦合问题，不会恢复运行时补丁和整个 rootfs。',
  ...
  'settingsUpdateInstallPermissionDenied': 'Hermes Agent 未被允许安装未知应用，因此无法打开安卓安装程序。',
  ...
  'messagePlatformDetailOfficialConfigHint':
      '\u5bf9\u5e94\u5b98\u65b9\u914d\u7f6e\u8282\u70b9\uff1aconfig.yaml \u4e2d\u7684 {path}',
  'messagePlatformDetailSchemaNote':
      '\u8868\u5355\u5b57\u6bb5\u6309\u7167 Hermes Agent \u5b98\u65b9 Lark / \u98de\u4e66 channel \u914d\u7f6e\u7ed3\u6784\u7f16\u5199\u3002',
  ...
  'messagePlatformDetailQqbotTokenHint':
      '\u4fdd\u5b58\u65f6\u4f1a\u6267\u884c hermes channels add --channel qqbot --token "<AppID>:<AppSecret>"\u3002',
  ...
  'gatewayInstallVersionConfirmBody':
      '\u5f53\u524d\u7248\u672c\uff1a{current}\n\u6240\u9009\u7248\u672c\uff1a{selected}\n\n\u8fd9\u4f1a\u4e34\u65f6\u505c\u6389\u7f51\u5173\uff0c\u5e76\u91cd\u65b0\u4e0b\u8f7d/\u5b89\u88c5 Hermes Agent\u3002\u786e\u8ba4\u7ee7\u7eed\u5417\uff1f',
  ...
  'settingsSnapshotVersionSnapshotHermes': '备份 Hermes Agent 版本：{version}',
  'settingsSnapshotVersionCurrentHermes':
      '\u5f53\u524d Hermes Agent \u7248\u672c\uff1a{version}',
