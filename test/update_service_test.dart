...
import 'package:hermes_agent/services/update_service.dart';

void main() {
  group('UpdateResult.preferredApkAssetForArch', () {
    const assets = [
      UpdateReleaseAsset(
        name: 'Hermes-v0.1.0-universal.apk',
        downloadUrl: 'https://example.com/universal.apk',
      ),
      UpdateReleaseAsset(
        name: 'Hermes-v0.1.0-arm64-v8a.apk',
        downloadUrl: 'https://example.com/arm64.apk',
      ),
      UpdateReleaseAsset(
        name: 'Hermes-v0.1.0-armeabi-v7a.apk',
        downloadUrl: 'https://example.com/arm.apk',
      ),
      UpdateReleaseAsset(
        name: 'Hermes-v0.1.0-x86_64.apk',
        downloadUrl: 'https://example.com/x86_64.apk',
      ),
      UpdateReleaseAsset(
        name: 'Hermes-v0.1.0.aab',
