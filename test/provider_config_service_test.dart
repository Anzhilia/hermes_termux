...
import 'package:hermes_agent/constants.dart';
import 'package:hermes_agent/models/custom_provider_preset.dart';
import 'package:hermes_agent/services/provider_config_service.dart';

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  const configPath = '/root/.hermes/config.yaml';
  const metadataPath = '/root/.hermes/app/custom-provider-presets.json';
