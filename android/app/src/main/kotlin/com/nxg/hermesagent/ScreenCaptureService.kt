...
class ScreenCaptureService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Fix #7: Register MediaProjection callback to handle system-initiated stops
        // (e.g. screen off, permission revoked). Without this, the service leaks resources.
    ...
    private fun stopRecording() {
        // Guard against multiple calls (timeout thread + MediaProjection callback + onDestroy)
    ...
    companion object {
        ...
        const val CHANNEL_ID = "hermes_screen_capture"
